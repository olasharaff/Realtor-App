...
import { Renting } from "../../datas/DiscoverDate";
      ...
      <div className="flex flex-wrap justify-center items-center m-auto  space-x-2 px-2 ">
        {Renting.map((item, index) => (
          ...
          >
            ...
            <Link to="">
              <span className="absolute bottom-4 text-black font-semibold border-b-2 border-gray-400 hover:border-black">
                {item.link}
              </span>
            </Link>
          </div>
